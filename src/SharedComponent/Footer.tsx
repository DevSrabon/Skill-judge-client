...
const Footer = () => { 
    return (
			<footer className="px-4 py-10 divide-y dark:bg-gray-900 dark:text-gray-100">
					...
					<div className="lg:w-1/3">
						...
						<div>
							...
							<div className="grid grid-cols-6 gap-y-3 gap-x-[7px]">
								<span className="bg-slate-300 btn btn-xs border-none hover:bg-emerald-400 text-black rounded-2xl text-[8px] lg:text-[10px]">
									JavaScript
								</span>
								<span className="bg-slate-300 btn btn-xs border-none hover:bg-emerald-400 text-black rounded-2xl text-center">
									C
								</span>
								<span className="bg-slate-300 btn btn-xs border-none hover:bg-emerald-400 text-black rounded-2xl text-center">
									C++
				...
				<div className="py-6 text-sm text-center dark:text-gray-400">
					© 2023. All rights reserved. by Skill Judges
				</div>
			</footer>
		);
