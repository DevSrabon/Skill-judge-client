        ...
        >
            <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
                <ul className="space-y-2">
                    ...
                    <SideBarItem link="/dashboard/allSubmission" name="All Submissions">
                        <svg
                            className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                    ...
                    <SideBarItem link="/dashboard/addProblem" name="Add Problem">
                        <svg
                            className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                    ...
                    <SideBarItem link="/dashboard/manageProblems" name="Manage Problems">
                        <svg
                            className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                            fill="currentColor"
                            viewBox="0 0 20 20"
