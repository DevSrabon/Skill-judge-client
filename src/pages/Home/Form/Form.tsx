			...
			<section className="lg:flex justify-center">
				...
				<div className="lg:w-3/6">
				  <form className="px-20 py-16 flex flex-col gap-y-10">
					...
					<div>
					  <label htmlFor="job" className="text-lg text-start">JOB TITLE</label>
					...
					<div>
					  <label htmlFor="role" className="text-lg font-sans">ROLE</label>
