		...
		<section className="bg-white dark:bg-gray-900">
         <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
           <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            ...
            <p className="mb-5 font-semibold text-gray-500 sm:text-xl dark:text-gray-400">Choose the best plan according to your need</p>
           </div>
          <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0"> 
            <div className="flex flex-col p-6 mx-auto max-w-lg text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:shadow-xl">
			  <div><FaFreeCodeCamp className="text-3xl dark:text-white"/></div>	 
              <h3 className="mb-4 text-3xl font-semibold">Free</h3>
              <p className="sm:text-lg dark:text-gray-400">Best option for personal use & for your next project.</p> 
              ...
              <Link to={"/free"} className="bg-emerald-400 hover:bg-emerald-600 text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white">Get started</Link>
            </div> 
            <div className="flex transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 flex-col p-6 mx-auto max-w-lg text-gray-900 bg-white rounded-lg border border-gray-100 dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white shadow-xl">
              ...
              <p className="sm:text-lg dark:text-gray-400">Relevant for multiple users, extended & premium support.</p>
              <div className="flex justify-center items-baseline my-8">
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 hover:shadow-xl">
			  <div><BsFillBriefcaseFill className="text-3xl"/></div>	
              <h3 className="mb-4 text-3xl font-semibold">Enterprise</h3>
              <p className="sm:text-lg dark:text-gray-400">Best for large scale uses and extended redistribution rights.</p>
              <div className="flex justify-center items-baseline my-8">
