		...
		<div>
			<div>
				<div className="relative">
					...
					<div className="flex justify-center">
						<HiLightBulb className="text-8xl dark:text-white" />
					</div>
					<h2 className=" text-center text-4xl md:text-6xl dark:text-white font-extrabold ">
						Explore and Practice <br /> languages
					</h2>
				...
				{/* <h1 className=" text-[40px] text-center font-extrabold dark:text-white">
					Explore and Practice languages
				</h1> */}
			</div>
			<div className="w-11/12 mx-auto grid gap-y-16 grid-cols-2 md:grid-cols-4 lg:grid-cols-6 justify-items-center mt-10 mb-14">
				<div className="card w-28 bg-base-100 shadow hover:shadow-xl border-2 border-amber-300">
					...
					<p className="text-center font-semibold dark:text-black font-mono mb-3">
						JavaScript
					</p>
				</div>
				...
				<div className="card w-28 bg-base-100 shadow hover:shadow-xl border-2 border-blue-400">
					<figure className="py-4">
						<img
							src="https://img.icons8.com/color/256/c-programming.png"
							alt="javascript"
							className="rounded-xl w-14"
						/>
					</figure>
				...
				<div className="card w-28 bg-base-100 shadow hover:shadow-xl border-2 border-black">
					<figure className="py-4">
						<img
							src="https://www.svgrepo.com/show/473774/rust.svg"
							alt="javascript"
							className="rounded-xl w-14"
						/>
					</figure>
				...
				<div className="card w-28 bg-base-100 shadow hover:shadow-xl border-2 border-rose-700">
					<figure className="py-4">
						<img
							src="https://www.svgrepo.com/show/374055/ruby.svg"
							alt="javascript"
							className="rounded-xl w-14"
						/>
					</figure>
				...
				<div className="card w-28 bg-base-100 shadow hover:shadow-xl border-2 border-black">
					<figure className="py-4">
						<img
							src="https://www.svgrepo.com/show/330035/battle-dot-net.svg"
							alt="javascript"
							className="rounded-xl w-14"
						/>
					</figure>
