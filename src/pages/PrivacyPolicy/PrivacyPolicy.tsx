    ...
    return (
      <div className="mx-10">
        <div className="flex gap-5 flex-col">
          <h1 className="text-4xl text-center underline underline-offset-8 decoration-2">
            Privacy Policy
          </h1>
          <p className="text-lg text-right underline underline-offset-8 decoration-1">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Skill Judge.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Skill Judge, accessible from{" "}
                <Link
                  to="https://skill-judge.netlify.app/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://skill-judge.netlify.app/
                </Link>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <Link
                to="https://skill-judge.netlify.app/about-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://skill-judge.netlify.app/about-us
              </Link>
            </li>
          </ul>
        </div>
