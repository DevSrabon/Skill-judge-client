...
const Qna = () => {
	...
	return (
        <div className="mx-20 ">
            <input type="search" name="" id="" onChange={handleSub} />
			<div className="flex justify-end">
				...
				<div className="modal">
					<div className="modal-box relative">
						...
						<form className="card p-3" onSubmit={handleSubmit(questionSubmit)}>
							<input
								type="text"
								...
								{...register("question")}
							/>
							<button type="submit" className="btn btn-accent my-10">
								submit
							</button>
						</form>
					</div>
